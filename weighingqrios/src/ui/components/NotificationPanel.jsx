      ...
      <View style={styles.sheet}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerRight}>
            {list.length > 0 && (
              <Pressable style={styles.clearBtn} onPress={() => dispatch(clearNotifications())}>
...
const styles = StyleSheet.create({
  ...
  sheet: {backgroundColor: COLORS.white, borderTopLeftRadius: 24, borderTopRightRadius: 24, maxHeight: '75%', paddingBottom: 32},
  ...
  clearBtn: {paddingHorizontal: 12, paddingVertical: 5, backgroundColor: COLORS.track, borderRadius: RADIUS.pill},
  ...
  item: {flexDirection: 'row', alignItems: 'flex-start', backgroundColor: COLORS.white, borderRadius: RADIUS.md, padding: SPACING.md, borderWidth: 1, borderColor: COLORS.border, gap: SPACING.md, ...SHADOWS.card},
